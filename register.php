...
?> <input type="reset" name="goback" value="Go Back" onClick="window.location.href='login.html';" />
<?php
}
else {
...
<input type="reset" name="goback" value="Cancel" onClick="window.location.href='login.html';" />
</li>
